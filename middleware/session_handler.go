...
func NewSessionHandler(secretKey string, verifyToken func(tokenString string, secret string) (map[string]interface{}, int64, int64, error), cache CacheService, sessionExpiredTime time.Duration, enableSession bool, logError func(ctx context.Context, format string, args ...interface{}), opts ...string) *SessionHandler {
