...
func NewUserInfoService(authenticationRepository AuthenticationRepository, maxPasswordAge int32, maxPasswordFailed int, lockedMinutes int) *DefaultUserInfoService {
