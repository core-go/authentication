...
func (r *UserRepository) getPasswordInfo(ctx context.Context, user *a.UserInfo, raw map[string]interface{}) *a.UserInfo {
...
func (r *UserRepository) upsertWithMap(ctx context.Context, collection *firestore.CollectionRef, id string, data map[string]interface{}) (int64, error) {
